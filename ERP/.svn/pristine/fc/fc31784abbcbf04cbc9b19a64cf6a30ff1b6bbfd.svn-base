...
<div class="list-content">
	...
	<table id="contentTable0" class="table table-striped table-bordered table-condensed resize">
					<tr>
						...
						<th colspan="6"><input type="text" value="${orderBomBase.orderBomNo}" class="input-medium" disabled="disabled"/></th>
						<th colspan="3"><span class="tab-name">项目名称：</span></th>
						<th colspan="6"><input type="text" value="${project.name}" class="input-medium" disabled="disabled"/></th>
						<th colspan="3"><span class="tab-name">苑区：</span></th>
						<th colspan="6"><input type="text" value="${project.location}" class="input-medium" disabled="disabled"/></th>
					</tr>
					<tr>
						<th colspan="3"><span class="tab-name">户型：</span></th>
						<th colspan="6"><input type="text" value="${orderBomBase.houseType }" class="input-medium" disabled="disabled"/></th>
						<th colspan="3"><span class="tab-name">楼栋号：</span></th>
						<th colspan="6"><input type="text" value="${subProject.buildingDisplayName }" class="input-medium" disabled="disabled"/></th>
						<th colspan="3"><span class="tab-name">饰面处理：</span></th>
						<th colspan="6"><input type="text" value="${orderBomBase.facingProcess }" class="input-medium" disabled="disabled"/></th>
					</tr>
					<tr>
						<th colspan="2"><span class="tab-name">石材品种：</span></th>
						<th colspan="25"><input type="text" value="${orderBomBase.showStoneColorName }" class="input-medium" disabled="disabled"/></th>
					</tr>
	</table>
	<div id="scroll-table">
		<div id="scroll-head">
				...
				<tbody>
					<c:forEach items="${listTwo}" var="items" varStatus="idx">
		              <tr>
		               ...
		               <td type="text" class="input-medium" name="list[${idx.index}].boxNo" id="boxNo">${items.boxNo }</td>
		               ...
		               <td type="text" class="input-medium" name="list[${idx.index}].lineDensity" id="wdight">${items.lineDensity }</td>
