...
/* 	$(function(){
		...
		$("#outsideWallOrientation").unbind("change").bind("change",function(){
			...
			inputForm.attr('action',startUp.getRootPath()+"/a/orbom/orderBomShowDetail/showDetail?orderType=2&orderBomId="+orderBomId+"&outsideWallOrientation="+outsideWallOrientation);
			inputForm.submit();				
		});
