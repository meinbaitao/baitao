...
public class ExecutionService extends CrudService<ExecutionDao, Execution> {
	...
	public String getmaxNo(){
		String result = "";
		String maxno = executionDao.getmaxNo();
		if(Integer.parseInt(maxno)<100 && Integer.parseInt(maxno)<10){
			result =  "BZ000"+String.valueOf(maxno);
    	}else if (Integer.parseInt(maxno)<100 && Integer.parseInt(maxno)>10){
    		result =  "BZ00"+String.valueOf(maxno);
    	}else{
    		result =  "BZ0"+String.valueOf(maxno);
    	}
		return result;
	}
