...
public abstract class DataEntity<T> extends BaseEntity<T> {
	...
	protected String gbCondition;	//group by condition 分组条件
	...
	public String getGbCondition() {
		return gbCondition;
	}

	public void setGbCondition(String gbCondition) {
		this.gbCondition = gbCondition;
	}
