...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/sys/dict/" ><span class="glyphicon glyphicon-list"></span>字典列表</a></li>
	          <shiro:hasPermission name="sys:area:edit"><li><a href="${ctx}/sys/dict/form?sort=10" class="active"><span class="glyphicon glyphicon-plus"></span>字典添加</a></li></shiro:hasPermission>
	        </ul>
