...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/sys/office/list?id=${office.id}&parentIds=${office.parentIds}" ><span class="glyphicon glyphicon-list"></span>机构列表</a></li>
	           <shiro:hasPermission name="sys:office:edit">
		           <li class="add_user">
		             <a href="${ctx}/sys/office/form?parent.id=${office.id}" class="active"><span class="glyphicon glyphicon-plus"></span>机构添加</a>
		           </li>
		      </shiro:hasPermission>
	        </ul>
	    </div>
