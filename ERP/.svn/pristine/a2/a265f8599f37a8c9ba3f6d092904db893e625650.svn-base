...
*/
    ...
    this.doZoomIn = function(e) {
      ...
      $(".appoint-saider").filter(":visible").find("h3>i").css({left:30+"px"});
      $(".appoint-saider").filter(":visible").css("overflow-x","scroll");
      self.zoomrestore = {
        style: {}
      };
    ...
    this.doZoomOut = function(e) {
      ...
      $(".appoint-saider").filter(":visible").find("h3>i").css({left:"auto"});
      $(".appoint-saider").filter(":visible").css("overflow-x","hidden");
      self.win.css("margin", "");
