...
<body>
	...
	<h1 class="form-signin-heading">${fns:getConfig('oauth2.serverName')}</h1>
	<h5 class="form-signin-heading">访问${client.clientName}授权登录</h5>
	<form id="loginForm" class="form-signin" action="" method="post">
		...
		<input class="btn btn-large btn-primary" type="submit" value="登录并授权"/>&nbsp;&nbsp;
