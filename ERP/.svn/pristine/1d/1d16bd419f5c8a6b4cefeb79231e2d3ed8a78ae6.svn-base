...
<div id="content" class="row-fluid">
		<div id="left">
			<iframe id="officeMenuFrame" name="officeMenuFrame" src="${ctx}/task/taskPlan/tree" style="overflow:visible;"
				scrolling="yes" frameborder="no" width="100%"></iframe>
		</div>
		<div id="openClose" class="close">&nbsp;</div>
		<div id="right">
		<iframe id="officeMainFrame" name="officeMainFrame" src="${ctx}/task/taskPlan/main"  style="overflow:visible;"
				scrolling="yes" frameborder="no" width="100%"></iframe>
