	...
	<div class="list-content">
		...
		<div class="nav-operate">
			<ul class="act">
				...
				<li><input type="radio" name="actRadio" value="2" attrUrl="${ctx}/contract/manufContractBase/findUnAuditManufContractBase" />我审批</li>
				<li><input type="radio" name="actRadio" value="3" attrUrl="${ctx}/contract/manufContractBase/findAuditDoneManufContractBase" checked="checked"/>所有</li>
			</ul>
			<form:form id="searchForm" modelAttribute="manufContractBase"
				action="${ctx}/contract/manufContractBase/findAuditDoneManufContractBase" method="post"
