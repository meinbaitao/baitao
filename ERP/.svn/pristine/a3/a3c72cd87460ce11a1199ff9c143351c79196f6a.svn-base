	...
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				...
				<li><input type="radio" name="actRadio" value="2" attrUrl="${ctx}/contract/stoneCarriageContractBase/findUnAuditStoneCarriageContractBase" checked="checked"/>我审批</li>
				<li><input type="radio" name="actRadio" value="3" attrUrl="${ctx}/contract/stoneCarriageContractBase/findAuditDoneStoneCarriageContractBase" />所有</li>
			</ul>
			<form:form id="searchForm" modelAttribute="stoneCarriageContractBase"
				action="${ctx}/contract/stoneCarriageContractBase/findUnAuditStoneCarriageContractBase" method="post"
