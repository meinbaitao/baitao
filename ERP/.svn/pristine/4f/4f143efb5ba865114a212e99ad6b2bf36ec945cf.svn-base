...
<!-- 			<p class=MsoNormalCxSpMiddle align=center
			...
			<p class=MsoNormalCxSpMiddle align=left
				...
				<b style='margin-left: 100px; mso-bidi-font-weight: normal'><span
					style='font-size: 16.0pt; mso-bidi-font-size: 14.0pt; line-height: 115%; font-family: "微软雅黑", "sans-serif"; color: black; mso-font-kerning: 0pt'>合同编号：</span></b><b
					style='mso-bidi-font-weight: normal'><input type="text" class="input_home" disable="true" value="${purchasingcontractbase.contractNo}"/></b><b
	...
	<!-- 		<p class=MsoNormalCxSpMiddle align=left
				...
				<b style='margin-left: 100px; mso-bidi-font-weight: normal;'><span
					style='font-size: 18.0pt; mso-bidi-font-size: 16.0pt; line-height: 115%; font-family: "微软雅黑", "sans-serif"; color: black; mso-font-kerning: 0pt'>甲<span
						...
						<u>广东万方建设有限公司<span lang=EN-US><span
								style='mso-spacerun: yes'>&nbsp; </span></span></u><span lang=EN-US><o:p></o:p></span></span></b>
			</p>
 -->
	...
	<!-- 		<p class=MsoNormalCxSpMiddle align=left
			...
			<p class=MsoNormal
				style='line-height: 150%; layout-grid-mode: char; mso-layout-grid-align: none'>
				<b style='mso-bidi-font-weight: normal'><span
					style='font-size: 12.0pt; mso-bidi-font-size: 10.5pt; line-height: 150%; font-family: "微软雅黑", "sans-serif"'>生产辅料木箱验收标准<span
						lang=EN-US><o:p></o:p></span></span></b>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、立柱材质为杂木或松木，宽度为<span
					lang=EN-US>70</span>±<span lang=EN-US>2mm,</span>厚度为<span
					lang=EN-US>20</span>±<span lang=EN-US>1mm</span>。<span lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、盖板竖板材质为杂木或松木，宽度为<span
					lang=EN-US>70</span>±<span lang=EN-US>2mm,</span>厚度为<span
					lang=EN-US>20</span>±<span lang=EN-US>1mm</span>。<span lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、底部木方材质为杂木或松木，宽度为<span
					lang=EN-US>90</span>±<span lang=EN-US>2mm,</span>厚度为<span
					lang=EN-US>50</span>±<span lang=EN-US>2mm</span>。<span lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、其他部位材质为杂木或松木，宽度为<span
					lang=EN-US>70</span>±<span lang=EN-US>2mm ,</span>厚度为<span
					lang=EN-US>20</span>±<span lang=EN-US>2mm</span>。<span lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、木箱四周立柱与横条之间要用铁皮钉紧。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、当长度小于或等于<span
					lang=EN-US>1450mm</span>时，需要用三条竖条及三条底方；长度<span lang=EN-US>1451</span>－<span
					lang=EN-US>2250mm</span>时，需要用四条竖条及四条底方；长度<span lang=EN-US>2251</span>－<span
					lang=EN-US>2900mm</span>时，需要用五条竖条及五条底方；长度<span lang=EN-US>2901</span>－<span
					lang=EN-US>3200mm</span>时，需要用六条竖条及六条立柱；<span lang=EN-US>3201mm</span>以上时需要用七条竖条及七条底方。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、当高度小于或等于<span
					lang=EN-US>800mm</span>时，需要用横条三条；高度<span lang=EN-US>801</span>－<span
					lang=EN-US>1350mm</span>时，需要用横条四条；高度<span lang=EN-US>1351</span>－<span
					lang=EN-US>1600mm</span>时，需要用横条五条。<span lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、木箱底板密封严实，缝隙小于<span
					lang=EN-US>3mm</span>。<span lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>、木板、木方不能虫蛀和开裂，带皮木方数不超过总木方数的<span
					lang=EN-US>8%</span>，单条木方带皮面积不能超过该条木方总面积的<span lang=EN-US>8%</span>。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
