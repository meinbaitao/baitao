...
import com.thinkgem.jeesite.modules.sys.dao.MysqlSeqDao;
...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public List<User> findUserNoneFilter(User user){
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	/**
	 * 根据条件读取相应的列表数据
	 * @param map	组合自己的条件，xml自主添加
	 * @return
	 */
	public List<Map<String,Object>> selByCondition(Map<String,Object> map){
		return userDao.selByCondition(map);
	}
	...
	public Integer getSeqCurrentVal(String seqName) {
		return seqDao.getCurrentVal(seqName);
	}
}
