...
<div class="list-content" >
    <div class="nav-operate" >
        <ul class="operationg-new" >
          <li ><a href="${ctx}/test/testData/" ><span class="glyphicon glyphicon-list"></span>单表列表</a></li>
          <shiro:hasPermission name="test:testData:edit"><li><a href="${ctx}/test/testData/form" class="active"><span class="glyphicon glyphicon-plus"></span>单表添加</a></li></shiro:hasPermission>
        </ul>
     </div>
