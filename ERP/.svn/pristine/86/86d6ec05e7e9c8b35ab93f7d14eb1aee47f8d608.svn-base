...
<body>
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="1" attrUrl="${ctx}/contract/purchasingContractBase/findMyPurchasingContractBase" />我发起</li>
				...
				<li><input type="radio" name="actRadio" value="3" attrUrl="${ctx}/contract/purchasingContractBase/findAuditDonePurchasingContractBase" checked="checked"/>所有</li>
			</ul>
			<form:form id="searchForm" modelAttribute="purchasingContractBase"
				action="${ctx}/contract/purchasingContractBase/findAuditDonePurchasingContractBase" method="post"
