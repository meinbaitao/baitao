...
<table border="0" cellspacing="0" class="table table-striped table-bordered table-condensed resize table-eidt">
 <form:hidden path="id"/>
  ...
  <tr height="38">
    ...
    <td width="18%"><form:input  htmlEscape="false" maxlength="200" class="input-medium required" path="exeNo" id="exeNo"  value="${flag eq 'view'?execution.exeNo:maxNo}" /></td>
  ...
  <tr height="38">
    ...
    <td width="15%">驻地管理员<span><font color="red">*</font></td>
    ...
    <td width="15%">驻地管理员身份证号<span><font color="red">*</font></td>
  ...
  <tr height="38">
    <td height="38" width="15%">驻地管理员联系方式<span><font color="red">*</font></td>
