	...
	<body lang=ZH-CN link=blue vlink=purple
		...
		<div class=Section1 style='layout-grid: 15.6pt'>
			...
			<p class=MsoNormalCxSpFirst align=center
				...
				<a name="_GoBack"></a><b style='mso-bidi-font-weight: normal'><span
					lang=EN-US
			...
			<p class=MsoNormal
				style='text-indent: 22.0pt; mso-char-indent-count: 2.0; line-height: 19.0pt; mso-line-height-rule: exactly'>
				<span style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>甲、乙双方确认经过平等协商、相互商讨，双方共同拟订了本承揽基本合同。甲、乙双方均认为本承揽基本合同是双方共同的真实意思表现，对合同条款已充分理解并完全同意。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>

			<p class=MsoNormal
				style='text-indent: 21.0pt; mso-char-indent-count: 2.0; line-height: 18.5pt; mso-line-height-rule: exactly'>
				<span lang=EN-US
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='mso-bidi-font-weight: normal'><u>乙</u></b>方提供。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>以整栋楼为结算单位，以甲方所下订单以及工地甲方工程人员验收为依据计算数量；每月<span
					lang=EN-US>25</span>日前乙方需把已完整发货的楼栋结算单提交到甲方审核，并在次月<span lang=EN-US>26</span>日前把经甲方审核确认结算金额的发票寄送到甲方财务。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					（期限为<span lang=EN-US>6</span>个月）。<span lang=EN-US><o:p></o:p></span>
				</span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体; color: black; mso-themecolor: text1'>乙方对产品的质量保修时间为四年，保修期自<u>双方结算之日</u>起算。保修期内产品出现石材返锈、防水失效、色差、臭洞等质量问题的，更换或维修所产生的材料费、运输费、拆装费及人工费用等均由乙方全部承担。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体; color: black; mso-themecolor: text1'>货款结算时预留货款总额的<span
					lang=EN-US>2%</span>作为质保金，两年内如没有发现质量问题的，该质保金甲方先予返还。质保金的先予返还不等于乙方保修责任完成，乙方的质量保修时间仍以上述<span
					lang=EN-US>19.1</span>条约定为准。<span lang=EN-US><o:p></o:p></span></span>
			</p>

			<p class=MsoNormal
				style='line-height: 19.0pt; mso-line-height-rule: exactly'>
				<span lang=EN-US
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体; color: black; mso-themecolor: text1'>20.1.1</span><span
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体; color: black; mso-themecolor: text1'>质保金按季度总结算金额直接从该季度</span><span
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体'>最后一个月（每年<span
					lang=EN-US>3</span>、<span lang=EN-US>6</span>、<span lang=EN-US>9</span>、<span
					lang=EN-US>12</span>月）累计一次性扣款，返还时间为扣款之日起两年。质保金返还为免息返还。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				style='line-height: 19.0pt; mso-line-height-rule: exactly'>
				<span lang=EN-US
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体'>20.1.2</span><span
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体'>预先退回质保金的产品发生质量问题后，若乙方不主动承担费用（甲方发出书面通知后三个工作日内未支付的），甲方有权在乙方货款或其他仍预留的质保金中直接扣除。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				style='line-height: 19.0pt; mso-line-height-rule: exactly'>
				<span lang=EN-US
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体'>20.1.3</span><span
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"'>本合同生效后<span
					lang=EN-US>1</span>个月内，乙方
				</span><span
					style='font-size: 11.0pt; font-family: "微软雅黑", "sans-serif"; mso-bidi-font-family: 宋体'>向甲方缴纳履约保证金<u><span
						lang=EN-US><span style='mso-spacerun: yes'>&nbsp; </span></span>贰拾<span
						lang=EN-US><span style='mso-spacerun: yes'>&nbsp; </span></span></u>万元，待合同期满或合法解除，乙方无其他未履行的义务后，甲方在<span
					lang=EN-US>5</span>天内无息退还。若乙方一个月内未缴纳履约保证金的，则视为授权甲方直接在应付乙方的货款中扣除。<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
			...
			<p class=MsoNormal
				...
				<b style='mso-bidi-font-weight: normal'><span lang=EN-US
					...
					style='mso-bidi-font-weight: normal'><input type="text" class="input_date" disable="true" value="${purchasingcontractbase.endTime}"/></b><b
					style='mso-bidi-font-weight: normal'><span
			...
			<p class=MsoNormal
				...
				<span lang=EN-US
					...
					style='mso-bidi-font-size: 10.5pt; font-family: "微软雅黑", "sans-serif"; color: red'>：<span
					lang=EN-US><o:p></o:p></span></span>
			</p>
