...
<body>
	<div class="list-content">
	   ...
	   <form:form id="generateForm" modelAttribute="purchaseDemand" action="${ctx}/purchase/purchase/generatePurchaseFL" onsubmit="javascript:return validateGP();" method="post" class="breadcrumb form-search">
