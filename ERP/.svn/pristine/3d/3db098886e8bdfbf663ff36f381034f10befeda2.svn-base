...
<body>
	...
	<div class="list-content">
	     <div class="nav-operate" >
           ...
           <form:form id="searchForm" modelAttribute="production" action="${ctx}/production/production/directorAssign" method="post" class="breadcrumb form-search">
				<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
				<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
				<input id="sisStatus" name="isStatus" type="hidden" value="${isStatus}"/>
				<input id="returnUrl" name="returnUrl" type="hidden" value="${ctx}/production/production/directorAssign"/>
		        <ul class="operationg-new" >
		        	<!-- 要求到货时间 -->
		        	<%-- <shiro:hasRole name="yyzy">
		        	...
		        	<shiro:hasAnyRoles name="${fns:getWhitelistsList('yyxscglzg')}">
		   ...
		   <thead>
            ...
            <tbody>
               ...
               <c:forEach items="${page.list}" var="production">
				<tr id="pro${production.project.id}" attrRole="yyzg" class="0 first-level hide-childen" haschild="true" previd="" islastone="true" depth="1">
					<td colspan="4">
						<div class="tit">
