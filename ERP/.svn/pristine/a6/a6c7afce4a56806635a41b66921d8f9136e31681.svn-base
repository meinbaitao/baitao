...
<body>
	...
	<div class="list-content">
	     <div class="nav-operate" >
	           ...
	           <form:form id="searchForm" modelAttribute="purchase" action="${ctx}/purchase/purchase/list" method="post" class="breadcrumb form-search">
		        ...
		        <ul class="operationg-new" >
					...
					<shiro:hasRole name="采购员">
						<li id="sendli" style="display:none;" class="operation-project" showWidth="450px" thisTagert="appoint-saider1" ></li>
		            	<li><input id="send" type="button" class="btn btn-primary" value="供应商发货"></li>
		           </shiro:hasRole>
		           <shiro:hasRole name="采购员">
		 ...
		 <table id="contentTable" class="table table-striped table-bordered table-condensed resize">
		   <thead>
			...
			<tr>
				...
				<%-- <td>${p.comment}</td> --%>
				<td>
					<a pIDTxt="${p.id}" href="javascript:void(0);" name="ghxq"><span class="operation-project" showWidth="600px" thisTagert="sendDetail" >
						供货详情
					</span></a>
				</td>
			</tr>
	...
	<div class="appoint-saider" id="appoint-saider1">
	 <form:form id="inputForm1" modelAttribute="inputForm1" action="${ctx}/purchase/purchase/suppSend" method="post"  class="form-horizontal">
       ...
       <h3><i></i>发货单</h3>
        <ul class="all-line-lis">
          ...
          <li>
           ...
           <li>
             <span class="tab-name">钢材厂发货金额：</span>
             <label>
          ...
          <li>
             ...
             <label>
                 <input type="submit" id="saveSend" name="saveSend" value="保存提交" class="btn btn-primary"/>
             </label>
          </li> 
       </ul>
       </form:form>
