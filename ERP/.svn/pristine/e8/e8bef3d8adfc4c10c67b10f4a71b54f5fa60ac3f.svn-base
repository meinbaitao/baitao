...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/cms/category/" ><span class="glyphicon glyphicon-list"></span>栏目列表</a></li>
	          <shiro:hasPermission name="cms:category:edit"><li><a href="${ctx}/cms/category/form" class="active"><span class="glyphicon glyphicon-plus"></span>用户添加</a></li></shiro:hasPermission>
	        </ul>
	     </div>
