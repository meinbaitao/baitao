...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/gen/genTable/"><span class="glyphicon glyphicon-list"></span>业务表列表</a></li>
	          <shiro:hasPermission name="gen:genTable:edit"><li><a href="${ctx}/gen/genTable/form"  class="active"><span class="glyphicon glyphicon-plus"></span>业务表添加</a></li></shiro:hasPermission>
	        </ul>
	    </div>
