...
$.extend($.fn, {
    ...
    buildIFrame: function(src) {
        ...
        if($(".jericho_tabs").length>1){ 
        	var jid='jerichotabiframe_' + $(".jericho_tabs.tab_selected").attr('id').replace('jerichotab_', '');    
    ...
    loadData: function(flag) {
        return this.each(function() {
            ...
            window.parent.changeNum=-1;//全局变量初始化
...
//                    removeLoading();
    ...
    applyHover: function() {
        return this.each(function() {
            $(this).hover(function() {
                ...
                var jid='jerichotabiframe_' + lastTab.attr('id').replace('jerichotab_', '');
    ...
    //修复selet2 bug
    select2_bug:function(fid){
    	var iObj;
    	if(document.getElementById(fid)){
    		var iObj = document.getElementById(fid).contentWindow;
    		if(iObj.document.getElementById("select2-drop-mask")){
    	     	  iObj.document.getElementById("select2-drop-mask").click();
    	        }
