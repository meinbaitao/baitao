...
<body>
	...
	<form:form id="detailForm" style="display:none;" action="${ctx}/purchase/purchase/getGCDetailBySeriesNumber" method="post" class="breadcrumb form-search">
		<input id="detailSN" name="seriesnumber" type="hidden" value=""/>
	</form:form>
	<div class="list-content">
	     <div class="nav-operate" >															
           <form:form id="searchForm" modelAttribute="purchase" action="${ctx}/purchase/purchase/purchaseGCList" method="post" class="breadcrumb form-search">
