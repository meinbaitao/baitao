...
<body>
	<!-- 流程提交 -->
	<form:form style="display:none;" id="submitACTForm" action="${ctx}/purchase/purchase/submitACTGC" onsubmit="javascript:return validateSubmit();" method="post" class="breadcrumb form-search">
		<input id="ids" name="sdIDs" type="hidden" value=""/>
	</form:form>
	<!-- 流程通过，进行下一步 -->
	<form:form style="display:none;" id="passACTForm" action="${ctx}/purchase/purchase/passACTGC" onsubmit="javascript:return validateSubmit();" method="post" class="breadcrumb form-search">
		<input name="wfID" value="${wfID }" type="text">
	</form:form>
	<!-- 驳回流程 -->
	<form:form style="display:none;" id="rebutACTForm" action="${ctx}/purchase/purchase/rebutACTGC" method="post" class="breadcrumb form-search">
	...
	<div class="form-actions">
		<!-- 返回 -->
		<a href="${ctx}/purchase/purchase/purchaseGCList" class="btn btn-primary">返回</a>
		<!-- 保存 -->
	...
	<div class="list-content">
		 ...
		 <div class="div_right" id="CPDiv">
			 <form id="saveForm" modelAttribute="" action="${ctx}/purchase/purchase/savePurchaseGC" method="post" onsubmit="javascript:return validateSubmitDemand();" class="form-horizontal">
