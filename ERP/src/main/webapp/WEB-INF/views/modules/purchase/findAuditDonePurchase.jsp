	...
	<div class="list-content">
	     <div class="nav-operate" >	
	     	<ul class="act">
				...
				<li><input type="radio" name="actRadio" value="2" />我审批</li>
				<li><input type="radio" name="actRadio" value="3" checked="checked"/>所有</li>
			</ul>														
           <form:form id="searchForm" modelAttribute="purchase" action="${ctx}/purchase/purchase/findAuditDonePurchase" method="post" class="breadcrumb form-search">
