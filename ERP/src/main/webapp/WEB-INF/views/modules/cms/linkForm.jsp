...
<div class="list-content" >
	    <div class="nav-operate" >
	         <ul class="operationg-new" >
	          <li ><a href="${ctx}/cms/link/?category.id=${link.category.id}" ><span class="glyphicon glyphicon-list"></span>链接列表</a></li>
	          <shiro:hasPermission name="cms:link:edit"><li><a class="active" href="<c:url value='${fns:getAdminPath()}/cms/link/form?id=${link.id}&category.id=${link.category.id}'><c:param name='category.name' value='${link.category.name}'/></c:url>"><span class="glyphicon glyphicon-plus"></span>链接添加</a></li></shiro:hasPermission>
	        </ul>
	     </div>
