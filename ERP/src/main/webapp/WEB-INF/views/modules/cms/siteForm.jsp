...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a  href="${ctx}/cms/site/" ><span class="glyphicon glyphicon-list"></span>站点列表</a></li>
	          <shiro:hasPermission name="cms:site:edit"><li><a class="active" href="${ctx}/cms/site/form"><span class="glyphicon glyphicon-plus"></span>站点添加</a></li></shiro:hasPermission>
	        </ul>
	     </div>
