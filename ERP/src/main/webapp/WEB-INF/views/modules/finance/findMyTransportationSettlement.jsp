...
<body>
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="2" attrUrl="${ctx}/finance/transportationSettlement/findMyTransportationSettlement" checked="checked"/>列表</li>
		...
		<form:form id="searchForm" modelAttribute="transportationSettlement"
			action="${ctx}/finance/transportationSettlement/findMyTransportationSettlement" method="post"
