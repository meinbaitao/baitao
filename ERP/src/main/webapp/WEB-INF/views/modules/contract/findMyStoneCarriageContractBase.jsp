...
<body>
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="1" attrUrl="${ctx}/contract/stoneCarriageContractBase/findMyStoneCarriageContractBase" checked="checked"/>我发起</li>
			...
			<form:form id="searchForm" modelAttribute="stoneCarriageContractBase"
				action="${ctx}/contract/stoneCarriageContractBase/findMyStoneCarriageContractBase" method="post"
