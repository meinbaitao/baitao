...
<body>
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="1" attrUrl="${ctx}/contract/accCarriageContractBase/findMyAccCarriageContractBase" checked="checked"/>我发起</li>
			...
			<form:form id="searchForm" modelAttribute="accCarriageContractBase"
				action="${ctx}/contract/accCarriageContractBase/findMyAccCarriageContractBase" method="post"
