...
<body>
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="1" attrUrl="${ctx}/contract/jiaContract/findMyJiaContract" />我发起</li>
				<li><input type="radio" name="actRadio" value="2" attrUrl="${ctx}/contract/jiaContract/findUnAuditJiaContract" />我审批</li>
				<li><input type="radio" name="actRadio" value="3" attrUrl="${ctx}/contract/jiaContract/findAuditDoneJiaContract" checked="checked"/>所有</li>
			</ul>
			<form:form id="searchForm" modelAttribute="jiaContract"
				action="${ctx}/contract/jiaContract/findAuditDoneJiaContract" method="post"
