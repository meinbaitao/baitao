...
<body>
	...
	<div class="list-content">
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="1" attrUrl="${ctx}/contract/laborDemand/findMyLaborDemand" checked="checked"/>我发起</li>
				<li><input type="radio" name="actRadio" value="2" attrUrl="${ctx}/contract/laborDemand/findUnAuditLaborDemand" />我审批</li>
...
<!-- 					<input id="deleteContract" class="btn btn-primary" type="button" value="删除合同"> -->
			...
			<form:form id="searchForm" modelAttribute="laborDemand"
				action="${ctx}/contract/laborDemand/findMyLaborDemand" method="post"
