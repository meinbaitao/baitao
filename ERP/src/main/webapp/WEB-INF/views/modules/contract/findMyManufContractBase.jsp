...
<body>
	...
	<div class="list-content">
		...
		<div class="nav-operate">
			<ul class="act">
				<li><input type="radio" name="actRadio" value="1" attrUrl="${ctx}/contract/manufContractBase/findMyManufContractBase" checked="checked"/>我发起</li>
			...
			<form:form id="searchForm" modelAttribute="manufContractBase"
				action="${ctx}/contract/manufContractBase/findMyManufContractBase" method="post"
