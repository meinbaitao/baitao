...
<body>
	...
	<div class="div_right" id="sendDiv">
	 <form:form id="inputForm1" modelAttribute="inputForm1" action="${ctx}/logistics/purchaseLogistics/receiptDXCPurchase" method="post"  onsubmit="javascript:return fromValidate();" class="form-horizontal">
