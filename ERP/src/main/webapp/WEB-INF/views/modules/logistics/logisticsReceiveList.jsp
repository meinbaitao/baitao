...
<body>
		   ...
		   <tr>
            ...
            <c:forEach items="${page.list}" var="items" varStatus="i">
              <tr>
               ...
               <td>
               <shiro:hasAnyRoles name="跟单员,采购员">
	...
	<h3><i></i>确认收货</h3>	
		 <ul>
	             ...
	             <label>
	                 <form:input path="logisticssendCode" htmlEscape="false" maxlength="200" readonly="true"/>
	          ...
	          <li>
	             ...
	             <label>
	                 <form:input path="sendFactory" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">承运方名称：</span>
	             <label>
	             	<form:input path="suppliersId" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>   
	          </li>
	          <li>
	             <span class="tab-name">运输合同：</span>
	             <label>
	                 <input id="carriageContractId" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">车辆长度要求：</span>
	             <label>
	                 <form:input path="vehicleLength" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">车辆吨位要求：</span>
	             <label>
	                 <form:input path="requireWeight" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">发货员：</span>
	             <label>
	                 <form:input path="sendUser" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">发货员电话：</span>
	             <label>
	                 <form:input path="sendPhone" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             ...
	             <label>
	                 ...
	                 <form:input path="planSendDate" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	          ...
	          <li>
	             ...
	             <label>
	                 <input id="receiverAddress" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">备注：</span>
	             <label>
	                 <form:input path="remark" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">司机姓名：</span>
	             <label>
	                 <form:input path="driveName" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">司机电话：</span>
	             <label>
	                 <form:input path="drivePhone" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">驾驶证号：</span>
	             <label>
	                 <form:input path="credentials" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">车牌号码：</span>
	             <label>
	                 <form:input path="vehicleNumber" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <li>
	          ...
	          <li>
	             ...
	             <label>
	                 <form:input path="quantity" htmlEscape="false" maxlength="200" readonly="true"/>
	             </label>
	          </li>
	          <div class="hr_ hr_20"></div>
	          <div class="hr_ hr_20"></div>
	          <li class="tips">勾选项</li>
	          <div class="hr_ hr_20"></div>
	           <table id="contentTable" class="table table-striped table-bordered table-condensed resize">
				   <thead>
				   <tr>
				   	 <th class="all-check">
				         <input type="checkbox" id="all-check" checked="false">
		 ...
		 <ul>
		 	<li class="line">
	             <p align="center">
	                 <input type="button" class="btn btn-primary"  value="提交" onclick="confirmReceive();"/>
	             </p>
             </li>
	     </ul>
	</form:form>
	...
	<h3><i></i>查看详情</h3>	
		 <ul>
	       	  <li>
	             <span class="tab-name">收货通知单号：</span>
	             <label>
	          ...
	          <li>
	             <span class="tab-name">发货员：</span>
	             <label>
	                 <input id="viewsendUser" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">发货员电话：</span>
	             <label>
	                 <input id="viewsendPhone" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">计划发货时间：</span>
	          ...
	          <li>
	             <span class="tab-name">备注：</span>
	             <label>
	                 <input id="viewremark" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li class="hr"></li>
	          <li>
	             <span class="tab-name">司机姓名：</span>
	             <label>
	                 <input id="viewdriveName" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">司机电话：</span>
	             <label>
	                 <input id="viewdrivePhone" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">驾驶证号：</span>
	             <label>
	                 <input id="viewcredentials" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">车牌号码：</span>
	             <label>
	                 <input id="viewvehicleNumber" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">发车重量：</span>
	             <label>
	                 <input id="viewweight" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li>
	             <span class="tab-name">总箱数：</span>
	             <label>
	                 <input id="viewquantity" readonly="true" type="text"/>
	             </label>
	          </li>
	          <li class="hr"></li>
	          <div class="hr_ hr_20"></div>
