...
<head>
	...
	<script type="text/javascript" src="${ctxStatic}/modules/task/examineTaskInfo.js"></script>
</head>
<body>
		...
		<div class="list-content" >
			<div class="nav-operate">
					<ul class="operationg-new" >
						<li><input id="noWay" class="btn btn-primary saveTaskPlan" type="button" value="驳回"></li>
						<li><input id="accept" class="btn btn-primary" type="button" value="通过"></li>
					</ul>
			<form:form id="searchForm" modelAttribute="taskPlan" action="${ctx}/task/examineTask/findByType" method="post" class="breadcrumb form-search">
				<ul class="search">
					<li>
									...
									<tr list="taskList" index="${idx.index}">
										...
										<c:choose>
											<c:when test="${subProject.status=='4'}">
												<td><input type="text" readonly="readonly" onclick="timeinput()" class="input-medium Wdate updateTaskPlan" name="taskList[${idx.index}].actualFinishTime" id="actualFinishTime${idx.index}" value="${subProject.actualFinishTime}"/></td>
												<td><input type="text" class="input-medium review" name="taskList[${idx.index}].finishReview" id="finishReview${idx.index}" maxlength="300" value="${subProject.finishReview}"/></td>
												<td><input type="text" class="input-medium" name="taskList[${idx.index}].summaryRemarks" id="summaryRemarks" maxlength="200" value="${subProject.summaryRemarks}"/></td>
											</c:when>
											<c:otherwise>
