...
<head>
	...
	<script type="text/javascript" src="${ctxStatic}/modules/task/examineTaskQuotaInfo.js"></script>
</head>
<body>
...
<div class="list-content">
	<div class="nav-operate">
		...
		<form:form id="searchForm" modelAttribute="taskQuotaPlan" action="${ctx}/task/examineTask/findByType" method="post" class="breadcrumb form-search">
			<ul class="search">
									...
									<tr list="taskQuotaPlanList" index="${idx.index}">
										...
										<c:choose>
											<c:when test="${subProject.status=='4'}">
												<td><input type="text"  class="input-medium work" name="taskQuotaPlanList[${idx.index}].actualFinishQuantity" id="actualFinishQuantity${idx.index}" value="${subProject.actualFinishQuantity}"></td>
												<td><input type="text" class="input-medium goal" name="taskQuotaPlanList[${idx.index}].goal" id="goal${idx.index}" value="${subProject.goal}"></td>
												<td><input type="text"  class="input-medium" name="taskQuotaPlanList[${idx.index}].summaryRemarks" id="summaryRemarks${idx.index}" maxlength="200" value="${subProject.summaryRemarks}"></td>
											</c:when>
											<c:otherwise>
