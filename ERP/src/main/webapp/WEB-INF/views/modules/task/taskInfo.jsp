...
<div class="list-content" >
			...
			<form:form id="searchForm" modelAttribute="taskPlan" action="${ctx}/task/taskPlan/findByOffice/${officeId}/${taskType}" method="post" class="breadcrumb form-search">
		...
		<form:form id="inputForm" name="inputForm" modelAttribute="taskPlan" action="" method="post" class="form-horizontal magbtm0">
			  ...
			  <table id="contentTable" class="table table-striped table-bordered table-condensed  table-eidt">
					<thead>
					   <tr list="taskList">
							...
							<th type="text"  class="input-medium" name="oneLevelPlan" maxlength="200" id="oneLevelPlan">一级计划</th>
							<th type="text"   class="input-medium" name="twoLevelPlan" maxlength="200" id="twoLevelPlan">二级计划</th>
							<th type="text"   class="input-medium required" name="taskDesc" maxlength="300" id="taskDesc">任务</th>
								...
								<c:choose>
									<c:when test="${subProject.status=='0'}">
										<tr list="taskList" index="${idx.index}">
											...
											<td  name="taskList[${idx.index}].summaryRemarks" id="summaryRemarks" maxlength="300">${subProject.summaryRemarks}</td>
