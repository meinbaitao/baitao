...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${categoryList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.name}", url:"${ctx}/task/adminPlan/findByOffice/${not empty tpl.id?tpl.id:tpl.parent.id}/${tpl.grade}", target:"officeMainFrame"},
		            </c:forEach>];
