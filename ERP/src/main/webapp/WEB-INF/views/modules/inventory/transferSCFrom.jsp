	...
	<div class="list-content">
	     <div class="nav-operate" >	
	       <ul class="operationg-new" >
               <a href="${ctx}/inventory/standingBook/transferSCList" class="btn btn-primary">返回</a>
	   ...
	   <form:form id="saveFrom" action="${ctx}/inventory/standingBook/transferSC" method="post" class="form-horizontal magbtm0">
	          <input style="display:none;" id="materialType" value="sc" type="text">
			 ...
			 <table id="contentTable" class="table table-striped table-bordered table-condensed resize table-eidt">
			   <thead>
	             ...
	             <tr list="listInv" class="copy" index="0">
			   		 ...
			   		 <th >栋号</th>
			   		 <th type="select" attr="outBox" id="outBox" name="outBox" class="input-medium">箱</th>
