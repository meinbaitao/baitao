...
<head>
	...
	<script src="${ctxStatic}/modules/accident/scripts/accidentForGFCSell.js?tsf=${jsVersion}" type="text/javascript"></script>
  ...
  <div class="list-content" >
      <div class="nav-operate" >
		<ul class="operationg-new" >
			<li>
				<form id="returnForm" action="${ctx}/accident/accidentManage/list?type=4" method="post" >
     ...
     <div class="form-content">
	  <form:form id="inputForm" modelAttribute="accidentManage" action="${ctx}/accident/accidentManage/${flag eq 'add'?'save':'update'}" method="post" class="form-horizontal magbtm0"> 
		  ...
		  <span id="hiddenFieldsContainer">
			 ...
			 <input type="hidden" name="type" id="accidentType" value="4"/>
		  ...
		  <li class="cols4">
			  ...
			  <label>
				  <input type="text"  id="requireArriveDate" name="requireArriveDate" value="${accidentManage.requireArriveDate}" readonly="readonly" onclick="timeinput()"  class="input115 required Wdate"/>
			  </label>
		  </li>
		  <li class="cols4">
				...
				<c:forEach items="${accidentManage.amdList}" var="item" varStatus="idx" >
					<tr list="amdList" index="${idx.index}">
						...
						<td name="amdList[${idx.index}].sj" id="amdList[${idx.index}].sj">
							<input type="text" readonly="true" class="input60" name="amdList[${idx.index}].jgc" id="amdList[${idx.index}].sj" value="${item.sj }">
						</td>
						...
						<td name="amdList[${idx.index}].gys" id="amdList[${idx.index}].gys">
							<input type="text" readonly="true" class="input60" name="amdList[${idx.index}].gys" id="amdList[${idx.index}].gys" value="${item.gys }">
						</td>
