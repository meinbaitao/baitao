...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/gen/genScheme/" ><span class="glyphicon glyphicon-list"></span>生成方案添加</a></li>
	          <shiro:hasPermission name="gen:genScheme:edit"><li><a href="${ctx}/gen/genScheme/form" class="active"><span class="glyphicon glyphicon-plus"></span>业务表添加</a></li></shiro:hasPermission>
	        </ul>
	     </div>
