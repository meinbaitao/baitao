...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/sys/area/" class="active"><span class="glyphicon glyphicon-list"></span>区域列表</a></li>
	          <shiro:hasPermission name="sys:area:edit"><li><a href="${ctx}/sys/area/form"><span class="glyphicon glyphicon-plus"></span>区域添加</a></li></shiro:hasPermission>
	        </ul>
        </div>
