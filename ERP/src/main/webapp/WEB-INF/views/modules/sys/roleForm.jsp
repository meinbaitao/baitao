    ...
    <div class="nav-operate" >
        <ul class="operationg-new" >
          ...
          <shiro:hasPermission name="sys:role:edit">
             <li><a href="${ctx}/sys/role/form" class="active"><span class="glyphicon glyphicon-plus"></span>角色添加</a></li>
          </shiro:hasPermission>
        </ul>
       </div>
       <div class="form-content">
		...
		<div class="control-group">
			...
			<div class="controls">
				<c:choose>
					<c:when test="${empty role.enname}">
						<%-- <input type="text" id="oldEnname" name="oldEnname" type="hidden" value="${role.enname}"> --%>
					...
					<c:otherwise>
						<input type="text"  id="oldEnname" name="oldEnname" class="required" readOnly="readOnly" value="${role.enname}">
					</c:otherwise>
				</c:choose>
			</div>
		</div>
