...
<div class="list-content" >
     <div class="nav-operate" >
        <ul class="operationg-new" >
           <li>
               <a href="${ctx}/sys/user/info" ><span class="glyphicon glyphicon-user"></span>个人信息</a>
           </li>
              <li><a href="${ctx}/sys/user/modifyPwd" class="active"><span class="glyphicon glyphicon-edit"></span>修改密码 </a></li>
        </ul>
     </div>
</div>
