...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/sys/role/" ><span class="glyphicon glyphicon-list"></span>角色列表</a></li>
	         <li ><a class="active" href="${ctx}/sys/role/assign?id=${role.id}"><shiro:hasPermission name="sys:role:edit"><span class="glyphicon glyphicon-lock"></span>角色分配</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit"><span class="glyphicon glyphicon-list"></span>人员列表</shiro:lacksPermission></a></li>
	        </ul>
        </div>
	...
	<div class="breadcrumb">
		...
		<input id="assignButton" class="btn btn-primary" type="submit" value="角色分配"/>
		<script type="text/javascript">
			$("#assignButton").click(function(){
				top.$.jBox.open("iframe:${ctx}/sys/role/usertorole?id=${role.id}", "角色分配",810,$(top.document).height()-240,{
