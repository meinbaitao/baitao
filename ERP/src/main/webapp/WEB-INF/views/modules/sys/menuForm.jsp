...
<div class="list-content" >
    <div class="nav-operate" >
        <ul class="operationg-new" >
          <li ><a href="${ctx}/sys/menu/"><span class="glyphicon glyphicon-list"></span>菜单列表</a></li>
          <shiro:hasPermission name="sys:area:edit"><li><a href="${ctx}/sys/menu/form"  class="active"><span class="glyphicon glyphicon-plus"></span>菜单添加</a></li></shiro:hasPermission>
        </ul>
       </div>
