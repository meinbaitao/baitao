...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/sys/role/" class="active"><span class="glyphicon glyphicon-list"></span>角色列表</a></li>
	          <shiro:hasPermission name="sys:role:edit">
	             <li><a href="${ctx}/sys/role/form"><span class="glyphicon glyphicon-plus"></span>角色添加</a></li>
	          </shiro:hasPermission>
	        </ul>
        </div>
