...
<div class="list-content">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed resize table-eidt">
	 ...
	 <table id="contentTable0" class="table table-striped table-bordered table-condensed resize">
					...
					<tr>
						<th colspan="3"><span class="tab-name">石材品种：</span></th>
						<th colspan="17"><input type="text" value="${orderBomBase.showStoneColorName }" class="input-medium" disabled="disabled"/></th>
					</tr>
	</table>
	<div id="scroll-table">
		<div id="scroll-head">
