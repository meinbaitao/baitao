	...
	<div class="list-content">
		...
		<div class="nav-operate">
			<ul class="operationg-new">
				...
				<li>
					<a href="${ctxTemplate}/骨架下料单.xls" id="costId" class="btn btn-primary">
						下载模板
					</a>
				</li>
				<li>
			...
			<form:form id="searchForm" modelAttribute="orderBomBase" action="${ctx}/orbom/orderBomBase/list?orderType=1&uniformMaterielType=2" method="post"
			...
			<tbody>
				<c:forEach items="${list}" var="items" varStatus="st">
	              <tr>
	               ...
	               <td><a href="${ctx}/orbom/orderBomDetail/list?orderBomId=${items.orderBomBase.id}&orderType=1&uniformMaterielType=2">查看明细</a></td>
	             </tr>
                </c:forEach>  
			</tbody>
		</table>
