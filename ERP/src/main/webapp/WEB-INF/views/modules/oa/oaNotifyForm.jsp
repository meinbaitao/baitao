...
<body>
  <div class="list-content" >
	      <div class="nav-operate" >          
		        <ul class="operationg" >
		           <li class="preserve" >保存</li>
		           <li class="pass-check" >审核</li>
		           <li class="fail-check" >驳回</li>	           
		           <li class="pass-all">批量审核</li>
		           <li class="delete" >删除</li>
		           <li  id="btnImport" class="import" >导入 </li>
		           <li  id="btnExport" class="export">导出</li>
		           <li class="add_user"><a href="${ctx}/oa/oaNotify/list">通知列表</a></li>
		        </ul>
		  </div>
  </div>
	  ...
	  <form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal"> 
		   ...
		   <c:if test="${oaNotify.status ne '1'}">
				...
				<div class="control-group">
					...
					<div class="controls">
		                <sys:treeselect id="oaNotifyRecord" name="oaNotifyRecordIds" value="${oaNotify.oaNotifyRecordIds}" labelName="oaNotifyRecordNames" 
