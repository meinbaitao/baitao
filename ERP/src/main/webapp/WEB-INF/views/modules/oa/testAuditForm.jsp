...
<div class="list-content" >
	<div class="nav-operate" >
		    <ul class="operationg-new" >
		       ...
		       <li>
		        <a href="${ctx}/oa/testAudit/" ><span class="glyphicon glyphicon-list"></span>审批列表</a>
		       </li>
		       <shiro:hasPermission name="oa:testAudit:edit">
		           <li>
		             <a href="${ctx}/oa/testAudit/form" class="active"><span class="glyphicon glyphicon-retweet"></span>审批申请流程</a>
		           </li>
		       </shiro:hasPermission>
		     </ul>
     </div>
