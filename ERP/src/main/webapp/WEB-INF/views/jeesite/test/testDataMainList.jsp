...
<div class="list-content" >
    <div class="nav-operate" >
        <ul class="operationg-new" >
          <li ><a href="${ctx}/test/testDataMain/"  class="active"><span class="glyphicon glyphicon-list"></span>主子表列表</a></li>
         <shiro:hasPermission name="test:testDataMain:edit"><li><a href="${ctx}/test/testDataMain/form"><span class="glyphicon glyphicon-plus"></span>主子表添加</a></li></shiro:hasPermission>
        </ul>
		...
		<ul class="search">
			...
			<li><label>性别：</label>
				<form:select path="sex" class="input-min60">
