...
<div class="list-content" >
	    <div class="nav-operate" >
	        <ul class="operationg-new" >
	          <li ><a href="${ctx}/test/testTree/" class="active"><span class="glyphicon glyphicon-list"></span>树结构列表</a></li>
	         <shiro:hasPermission name="test:testTree:edit"><li><a href="${ctx}/test/testTree/form"><span class="glyphicon glyphicon-plus"></span>树结构添加</a></li></shiro:hasPermission>
	        </ul>
