...
<div class="list-content" >
    <div class="nav-operate" >
        <ul class="operationg-new" >
          <li ><a href="${ctx}/test/testDataMain/"  ><span class="glyphicon glyphicon-list"></span>主子表列表</a></li>
         <shiro:hasPermission name="test:testDataMain:edit"><li><a href="${ctx}/test/testDataMain/form" class="active"><span class="glyphicon glyphicon-plus"></span>主子表添加</a></li></shiro:hasPermission>
        </ul>
    </div>
