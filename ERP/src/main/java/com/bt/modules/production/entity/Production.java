 ...
 */
package com.bt.modules.production.entity;
...
public class Production extends DataEntity<Production> {
	...
	private LogisticsSend logisticsSend;		// 物流信息-发货单
	private int sumCount;		// 生产数量总计
	
	//判断对应的角色是否对相应的数据拥有对应的权限
	private boolean operationSpecialistFlag;
	private boolean coordinatorLeaderFlag;
	private boolean assigntoFlag;
	...
	public Production(String id,String status){
		this.id=id;
...
//	}
	...
	public void setScjl(User scjl) {
		this.scjl = scjl;
	}

	public boolean getOperationSpecialistFlag() {
		return operationSpecialistFlag;
	}

	public void setOperationSpecialistFlag(boolean operationSpecialistFlag) {
		this.operationSpecialistFlag = operationSpecialistFlag;
	}

	public boolean getCoordinatorLeaderFlag() {
		return coordinatorLeaderFlag;
	}

	public void setCoordinatorLeaderFlag(boolean coordinatorLeaderFlag) {
		this.coordinatorLeaderFlag = coordinatorLeaderFlag;
	}

	public boolean getAssigntoFlag() {
		return assigntoFlag;
	}

	public void setAssigntoFlag(boolean assigntoFlag) {
		this.assigntoFlag = assigntoFlag;
	}
